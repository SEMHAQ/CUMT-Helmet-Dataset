...
As this dataset is compiled from multiple sources, label contamination exists.   
This project addresses classification issues and converts the dataset to YOLO format.
